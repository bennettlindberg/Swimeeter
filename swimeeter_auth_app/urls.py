...
from .views import Log_in, Sign_up, Log_out, Update_profile, Update_preferences, Delete_account, Deactivate_account, Init_check
...
urlpatterns = [
    ...
    path('deactivate_account/', Deactivate_account.as_view()),
