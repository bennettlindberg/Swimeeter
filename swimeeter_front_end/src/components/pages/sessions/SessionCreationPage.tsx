...
import { SessionCreationForm } from "../../sections/creation_pages/SessionCreationForm.tsx";
...
export function SessionCreationPage() {
    ...
    if (!userState.logged_in) {
        navigate("/log_in", { state: { forwardTo: `/meets/${meet_id_INT}/sessions/create` }, replace: true });
    }
    ...
    // * update tab title
    useEffect(() => setTabTitle("Create a Session | Swimeeter"), []);

    // * create main content section refs
    const createSessionRef = useRef<HTMLHeadingElement>(null);
