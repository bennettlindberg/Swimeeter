        ...
        case "SMALL":
            return (
                <svg className={userState.preferences.motion_safe ? "motion-safe:animate-translate_sm" : ""} width="200" height="8">
                    <rect className="fill-sky-400" mask="url(#sm-ellipse-mask)" width="200" height="4" x="0" y="0" />
                    <ellipse className="fill-sky-400" cx="150" cy="3.1" rx="50" ry="4" />
                    <defs>
        ...
        case "MEDIUM":
            return (
                <svg className={userState.preferences.motion_safe ? "motion-safe:animate-translate_md" : ""} width="250" height="14">
                    <rect className="fill-sky-300" mask="url(#md-ellipse-mask)" width="250" height="7" x="0" y="0" />
                    <ellipse className="fill-sky-300" cx="187.5" cy="5.75" rx="62.5" ry="7" />
                    <defs>
        ...
        case "LARGE":
            return (
                <svg className={userState.preferences.motion_safe ? "motion-safe:animate-translate_lg" : ""} width="300" height="20">
                    <rect className="fill-cyan-300" mask="url(#lg-ellipse-mask)" width="300" height="10" x="0" y="0" />
                    <ellipse className="fill-cyan-300" cx="225" cy="8.5" rx="75" ry="10" />
                    <defs>
