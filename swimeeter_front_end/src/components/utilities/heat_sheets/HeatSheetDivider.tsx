...
export function HeatSheetDivider({
    ...
    switch (color) {
        case "orange":
            interpretedButtonColor = "bg-orange-100 group-hover/header:bg-orange-200 border-orange-200 dark:bg-orange-900 group-hover/header:dark:bg-orange-800 dark:border-orange-800";
            interpretedTextColor = "text-orange-400 dark:text-orange-500"
            interpretedFillColor = "fill-orange-400 dark:fill-orange-500"
            break;

        case "purple":
            interpretedButtonColor = "bg-purple-100 group-hover/header:bg-purple-200 border-purple-200 dark:bg-purple-900 group-hover/header:dark:bg-purple-800 dark:border-purple-800";
            interpretedTextColor = "text-purple-400 dark:text-purple-500"
            interpretedFillColor = "fill-purple-400 dark:fill-purple-500"
            break;

        case "slate":
            interpretedButtonColor = "bg-slate-100 group-hover/header:bg-slate-200 border-slate-200 dark:bg-slate-800 group-hover/header:dark:bg-slate-700 dark:border-slate-700";
            interpretedTextColor = "text-slate-400 dark:text-slate-500"
            interpretedFillColor = "fill-slate-400 dark:fill-slate-500"
            break;

        case "primary":
            interpretedButtonColor = "bg-sky-100 group-hover/header:bg-sky-200 border-sky-200 dark:bg-blue-900 group-hover/header:dark:bg-blue-800 dark:border-blue-800";
            ...
            <tr>
                <td className="pl-5 pr-0" colSpan={2}>
                    <TableGrid>
                        ...
                        <thead className={`group/header py-1 font-semibold text-xl ${interpretedButtonColor} ${interpretedTextColor}`} onClick={() => setIsOpen(!isOpen)}>
