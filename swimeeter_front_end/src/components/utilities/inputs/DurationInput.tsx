    ...
    return (
        <>
            <div className="flex flex-row items-center gap-x-1">
                ...
                <p className="text-lg font-semibold">:</p>
                <input id={`${idPrefix}-second-field`} className="max-w-[40px] text-lg rounded-md border-2 border-slate-400 dark:border-slate-500 focus:border-sky-400 focus:dark:border-blue-500 focus:outline-none bg-white dark:bg-black" type="text" placeholder="SS" value={inputSecondText} onChange={handleSecondChange}/>
                <p className="text-lg font-semibold">.</p>
                <input id={`${idPrefix}-decimal-field`} className="max-w-[40px] text-lg rounded-md border-2 border-slate-400 dark:border-slate-500 focus:border-sky-400 focus:dark:border-blue-500 focus:outline-none bg-white dark:bg-black" type="text" placeholder="DD" value={inputDecimalText} onChange={handleDecimalChange}/>
            </div>
        </>
    )
}