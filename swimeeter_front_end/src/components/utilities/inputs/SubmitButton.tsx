...
// ~ component
export function SubmitButton({ color, handleClick, text, icon, idPrefix }: {
    ...
    return (
        <>
            <input className={`flex flex-row gap-x-2 items-center px-2 py-1 w-fit rounded-full border-2 ${interpretedButtonColor}`} id={idPrefix + "-submit-button"} type="submit" onClick={handleClick}>
