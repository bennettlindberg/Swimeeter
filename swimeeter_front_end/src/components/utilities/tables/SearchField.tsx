        ...
        case "POOL":
            return (
                <div className="group flex flex-row p-0 gap-x-0 items-stretch" tabIndex={0}>
                    ...
                    <button type="button" onClick={handleSearch} className="rounded-md rounded-l-none p-0.5 border-2 hover:bg-slate-200 border-slate-400 group-focus-within:border-sky-400 hover:dark:bg-slate-700 dark:border-slate-500 group-focus:dark:border-blue-500 border-l-0">
                        <IconSVG icon="FILTER" color="fill-slate-400 dark:fill-slate-500" width="w-[25px]" height="h-[25px]" />
                    </button>
                </div>
            );
        ...
        case "INDIVIDUAL_ENTRY_OF_SWIMMER":
            return (
                <>
                    <div className="group flex flex-row p-0 gap-x-0 items-stretch" tabIndex={0}>
            <input id={`${idPrefix}-distance-search-field`} className="w-[100px] px-1 text-lg rounded-md rounded-r-none border-2 border-slate-400 dark:border-slate-500 group-focus-within:border-sky-400 group-focus-within:dark:border-blue-500 focus:outline-none bg-white dark:bg-black border-r-0" type="text" placeholder="Distance" onKeyUp={preCheckReturn} onChange={handleNumericFieldChange} />
                        <input id={`${idPrefix}-stroke-search-field`} className="w-[100px] px-1 text-lg rounded-md rounded-l-none rounded-r-none border-2 border-slate-400 dark:border-slate-500 group-focus-within:border-sky-400 group-focus-within:dark:border-blue-500 focus:outline-none bg-white dark:bg-black" type="text" placeholder="Stroke" onKeyUp={preCheckReturn} />
                        <button type="button" onClick={handleSearch} className="rounded-md rounded-l-none p-0.5 border-2 hover:bg-slate-200 border-slate-400 group-focus-within:border-sky-400 hover:dark:bg-slate-700 dark:border-slate-500 group-focus:dark:border-blue-500 border-l-0">
                            <IconSVG icon="FILTER" color="fill-slate-400 dark:fill-slate-500" width="w-[25px]" height="h-[25px]" />
                        </button>
                    </div>
